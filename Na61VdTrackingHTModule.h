...
#define NA61_Na61VdTrackingHTModule
...
class Na61VdTrackingHTModule : public Na61VdTrackingModule {
 public:
  Na61VdTrackingHTModule();
  Na61VdTrackingHTModule(const char* name, const char* title);
  virtual ~Na61VdTrackingHTModule() {}
 ...
 public:
  //  ClassDef(Na61VdTrackingHTModule,0) // DOCUMENT ME
};
