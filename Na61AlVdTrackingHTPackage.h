...
//
//
#ifndef NA61_Na61AlVdTrackingHTPackage
#define NA61_Na61AlVdTrackingHTPackage
...
class Na61AlVdTrackingHTPackage : public Na61AlVdTrackingModule {

 public:

  Na61AlVdTrackingHTPackage();
  Na61AlVdTrackingHTPackage(const char* name, const char* title);
  virtual ~Na61AlVdTrackingHTPackage() {}
 ...
 private:
  Na61AlVdTrackingHTModule* fTrackingHTModules[20];
 ...
 public:
  //  ClassDef(Na61AlVdTrackingHTPackage,0) // DOCUMENT ME
};
